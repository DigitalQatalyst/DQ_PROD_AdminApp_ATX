...
export const DevLogin: React.FC<DevLoginProps> = ({ className = "" }) => {
  ...
  // Only show when mock auth is enabled
      ...
      {isExpanded && (
        <div className="mt-4">
          ...
          <div className="mt-4 text-xs text-gray-600">
            <p>
              <strong>Test Cases (RBAC v2):</strong>
            </p>
            <ul className="list-disc list-inside mt-1 space-y-1">
              <li>
                <strong>Internal users:</strong> Full access to all content (no
                org filter)
              </li>
              <li>
                <strong>Partner + Organization:</strong> Org-scoped access only
              </li>
              <li>
                <strong>Partner + No Org:</strong> Should be blocked (403)
              </li>
              <li>
                <strong>Customer + Any:</strong> Should be blocked from Admin
                App (403)
              </li>
              <li>
                <strong>Viewer role:</strong> Read-only access to directories
              </li>
              <li>
                <strong>Editor role:</strong> Can create/update content
              </li>
              <li>
                <strong>Approver role:</strong> Can approve content
              </li>
              <li>
                <strong>Admin role:</strong> Full access
              </li>
            </ul>
          </div>
        </div>
