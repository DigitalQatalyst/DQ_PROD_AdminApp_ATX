...
export const initialLeads: Lead[] = [
  {
    ...
    createdAt: '2026-02-01T09:00:00Z', notes: 'Interested in full DCO assessment for their Dubai operations',
    activities: [
      act('Lead created from website form submission', 'note', 'System', '2026-02-01T09:00:00Z'),
      act('Initial discovery call - interested in digital transformation roadmap', 'call', 'Sarah Al-Rashid', '2026-02-03T14:30:00Z'),
      act('Status changed from New to Qualified', 'status_change', 'Sarah Al-Rashid', '2026-02-03T15:00:00Z'),
    ],
  },
  {
    ...
    createdAt: '2026-02-02T11:30:00Z', notes: 'Attended AI Strategy webinar, asked detailed questions',
    activities: [
      act('Lead created from webinar attendance', 'note', 'System', '2026-02-02T11:30:00Z'),
      act('Welcome email sent', 'email', 'System', '2026-02-02T11:35:00Z'),
    ],
  },
  {
    ...
    createdAt: '2026-01-28T08:15:00Z', notes: 'Referred by Minister of Digital Affairs. Large-scale DT project.',
    activities: [
      act('Lead created from referral', 'note', 'System', '2026-01-28T08:15:00Z'),
      act('Demo scheduled for Feb 10', 'meeting', 'James Chen', '2026-02-05T10:00:00Z'),
    ],
  },
  {
    ...
    createdAt: '2026-02-08T16:45:00Z', notes: 'Small startup looking for cloud migration support',
    activities: [act('Lead created from chatbot', 'note', 'System', '2026-02-08T16:45:00Z')],
  },
  {
    ...
    createdAt: '2026-02-05T13:20:00Z', notes: 'Found us on marketplace, needs advanced analytics platform',
    activities: [act('Lead created from marketplace', 'note', 'System', '2026-02-05T13:20:00Z')],
  },
  {
    ...
    createdAt: '2026-02-03T10:00:00Z', notes: 'Interested in DTMI licensing for internal use',
    activities: [act('Lead created from website form', 'note', 'System', '2026-02-03T10:00:00Z')],
  },
  {
    ...
    createdAt: '2026-02-09T07:30:00Z', notes: 'Emailed requesting AI strategy consultation',
    activities: [act('Lead created from email', 'note', 'System', '2026-02-09T07:30:00Z')],
  },
  {
    ...
    createdAt: '2026-01-25T14:00:00Z', notes: 'Referred by partner. Advanced AI implementation project.',
    activities: [act('Lead created from referral', 'note', 'System', '2026-01-25T14:00:00Z')],
  },
  {
    ...
    createdAt: '2026-01-15T11:00:00Z', notes: 'Successfully converted. Cloud migration project starting March.',
    activities: [
      act('Lead created from website form', 'note', 'System', '2026-01-15T11:00:00Z'),
      act('Status changed to Converted', 'status_change', 'Fatima Al-Sayed', '2026-02-01T09:00:00Z'),
    ],
  },
  {
    ...
    createdAt: '2026-01-20T06:00:00Z', notes: 'Lost to competitor. Budget constraints cited.',
    activities: [act('Lead created from email', 'note', 'System', '2026-01-20T06:00:00Z')],
  },
  {
    ...
    createdAt: '2026-02-12T09:00:00Z', notes: 'Submitted service request for digital transformation.',
    activities: [act('Service request form submitted', 'note', 'System', '2026-02-12T09:00:00Z')],
  ...
  },
  {
    ...
    createdAt: '2026-02-12T10:30:00Z', notes: 'Requested demo for DTMP platform.',
    activities: [act('Product demo request submitted', 'note', 'System', '2026-02-12T10:30:00Z')],
  ...
  },
  {
    ...
    createdAt: '2026-02-11T14:00:00Z', notes: 'Wants to visit the Nairobi studio.',
    activities: [act('Tour request form submitted', 'note', 'System', '2026-02-11T14:00:00Z')],
    formType: 'tour-request', priority: 'Medium', groupSize: '6-10 people',
    preferredDate: '2026-03-15', preferredTime: 'Morning (9:00 AM - 12:00 PM)',
  ...
  },
  {
    ...
    createdAt: '2026-02-11T16:45:00Z', notes: 'Requested consultation on Retail 4.0.',
    activities: [act('Consultation request submitted', 'note', 'System', '2026-02-11T16:45:00Z')],
